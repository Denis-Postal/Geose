...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.once("complete", () => {
      ...
      this.load.image("geose_bg", "assets/Geose/Texture/bg.png?v=" + Date.now());
      this.load.image("geose_button_import", "assets/Geose/Texture/button_import.png?v=" + Date.now());
      this.load.image("spider_texture", "assets/Geose/Texture/spider.png?v=" + Date.now());
