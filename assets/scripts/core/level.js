...
window.LevelObject = class LevelObject {
  ...
  _spawnLevelObjects(_0x35f1ae) {
    ...
    for (let levelObj of _0x35f1ae) {
      ...
      const _registerObjectSprite = (spr) => {
        if (!spr) return;
      ...
      if (frameName) {
        ...
        if (_0x501fde) {
          ...
          if (backSprite) {
            ...
            _registerObjectSprite(backSprite);
          }
        }
        let _0xOrbGlow = null;
        if (objectDef.glow && !window.isEditor) {
          ...
          if (_0xOrbGlow) {
            ...
            _registerObjectSprite(_0xOrbGlow);
          }
        }
        ...
        if (sprite) {
          ...
          if (frameName && frameName.indexOf("sawblade") >= 0) {
            ...
            if (_sawMirror) {
              ...
              _registerObjectSprite(_sawMirror);
            }
          }
        } else {
        }
        if (objectDef && (objectDef.type === solidType || objectDef.type === hazardType)) {
          ...
          if (overlaySprite) {
            ...
            _registerObjectSprite(overlaySprite);
          }
        }
        if (objectDef.children) {
          for (let childDef of objectDef.children) {
            ...
            if (childSprite) {
              ...
              _registerObjectSprite(childSprite);
              if (frameName && frameName.indexOf("sawblade") >= 0) {
                ...
                if (_childMirror) {
                  ...
                  _registerObjectSprite(_childMirror);
                }
              }
            }
          }
